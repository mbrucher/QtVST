...
plt.figure()
oversampling.plot_me(signal, 0, 2, MySampleRate = SampleRate)
oversampling.plot_me(overdriven_oversampled_signal[:, ::2], 1, 2, MySampleRate = SampleRate)

plt.figure()
oversampling.plot_me(signal, 0, 2, MySampleRate = SampleRate)
print "Filtered overdrive oversampling"
filtered_overdriven_oversampled_signal = ssignal.lfilter(b, a, overdriven_oversampled_signal)
